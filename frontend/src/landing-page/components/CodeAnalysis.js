...
export default function CodeAnalysis() {
  ...
  let getEditorValue = async () => {
    ...
    // );
    onSentAnalysis(
      "You are a highly skilled python software developer and code analyser. I have a source code. Your task is to Identify given code is python or not. If not then simply ask to provide python code. If the given code is in python then analyse and write the meaning of each line of code. Your explaination title must start with 'Code Analyse Explaination : ' then your explaination from next line'. Here’s the code: " +
        inputAnalysis
    );
      ...
      <Box sx={{ bgcolor: "background.default" }}>
        ...
        >
          ...
          >
            ...
            >
              Our website provide a platform, designed specifically for Python
        ...
        <h3
          ...
          class="question"
        >
          Write Your Python Code Here To Analyse
        </h3>
